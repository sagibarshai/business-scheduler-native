...
export const theme: DefaultTheme = {
  ...
  border: {
    colors: { black: "rgba(0,0,0,1)", aqua: "rgba(7, 137, 179, 1)", aquaAlpha5: "rgba(7, 137, 179, 0.5)",purple:"rgba(51, 47, 68, 1)",gray:"rgba(202, 202, 202, 1)" },
    width: { m: "1px" },
...
inputs: {
  ...
  icons:{
    sizes:{m:22, xl:40},
    colors:{aqua:"rgba(7, 137, 179, 1)", aquaDisabled:"rgba(7, 137, 179, 0.5)", white:'rgba(255,255,255,1)', purple:"rgba(51, 47, 68, 1)",black:"rgba(0,0,0,1)", gray:"rgba(202, 202, 202, 1)"}
  } ,
};